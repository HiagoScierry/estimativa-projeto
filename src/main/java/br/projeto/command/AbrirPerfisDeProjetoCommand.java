...
import br.projeto.presenter.PerfisDeProjetoPresenter;
...
public class AbrirPerfisDeProjetoCommand implements ProjetoCommand{
    private final JDesktopPane desktop;
    private final String titulo;

    public AbrirPerfisDeProjetoCommand(JDesktopPane desktop, String titulo) {
    ...
    public void execute() {
        ...
        if (windowManager.isFrameAberto(titulo)) {
            ...
            PerfisDeProjetoPresenter presenter = new PerfisDeProjetoPresenter();
